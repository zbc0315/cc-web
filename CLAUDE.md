...
**当前版本**: v2026.5.18-i ｜ **包名**: `@tom2012/cc-web` ｜ **MIT** ｜ https://github.com/zbc0315/cc-web
...
项目：`@tom2012/cc-web`。当前版本 **v2026.5.18-i**（2026-05-18 发布，npm registry latest，新增运行中工作轨右下角悬浮半透明 minimap card，实时显示节点缩略图 + 高亮当前节点；节点 schema 加用户可填 label 字段；reducer 强化 type 不可变保护）。daemon 是否已升级 = 用户当前消息明示，过去会话授权不传递。
